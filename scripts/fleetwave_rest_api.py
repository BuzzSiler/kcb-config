...
def DoReservation(client_name, kiosk_number, card_id, action):
    '''
    ...
    logging.debug("PayrollNumber: %s", response_payrollnumber)
    
    return return_code, box, transaction_number, response_payrollnumber

# Perform the 'Take' request
def TakeKeyReservation(client_name, kiosk_number, card_id):
    '''
    ...
    '''
    return DoReservation(client_name, kiosk_number, card_id, action="COLLECTING")

# Perform the 'Return' request
def ReturnKeyReservation(client_name, kiosk_number, card_id):
    '''
    ...
    Sent from Keybox to FleetWave using Reservation2
        ...
        payrollNumber = Received from HID card
    '''
    return DoReservation(client_name, kiosk_number, card_id, action="RETURNING")
...
def DoTransactionComplete(client_name, transaction_number, payroll_number, answer1="", answer2="", answer3=""):
    ...
    Sent from FleetWave to Keybox
        ...
        <Result xmlns="Chevin.WebServices.SafePak" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            ...
            NOTE: Ignore Payroll number returned
            <Payrollnumber>10307</Payrollnumber>
        </Result>
    '''
    logging.debug("ClientName: %s", client_name)
